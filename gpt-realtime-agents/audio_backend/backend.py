...
DEFAULT_VOICE = os.getenv("AZURE_GPT_REALTIME_VOICE", "ballad")
AZURE_API_KEY_RAW = os.getenv("AZURE_GPT_REALTIME_KEY")
AZURE_API_KEY = AZURE_API_KEY_RAW.strip().strip('"').strip("'") if AZURE_API_KEY_RAW else None
